...
public class TransactionServiceImpl implements TransactionService {
  ...
  public void transferBetweenAccounts(
    ...
    String baseDescription =
        (description != null && !description.isBlank()) ? description : "Transfer between accounts";
    ...
    TransactionEntity outgoingTransaction =
    ...
    TransactionEntity incomingTransaction =
        TransactionEntity.builder()
            .date(date)
  ...
  private boolean filterByDateRange(
      TransactionEntity transaction, LocalDate dateFrom, LocalDate dateTo) {
  ...
  private boolean filterByAmountRange(
      TransactionEntity transaction, BigDecimal amountMin, BigDecimal amountMax) {
    BigDecimal transactionAmount = transaction.getAmount();
    if (amountMin != null
        && (transactionAmount == null || transactionAmount.compareTo(amountMin) < 0)) {
      return false;
    }
    if (amountMax != null
        && (transactionAmount == null || transactionAmount.compareTo(amountMax) > 0)) {
      return false;
    }
    return true;
  }
